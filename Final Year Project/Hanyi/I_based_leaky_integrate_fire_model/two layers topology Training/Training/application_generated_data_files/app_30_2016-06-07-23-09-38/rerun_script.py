...
binaries.add_subsets("C:\\Python27\\lib\\site-packages\\spynnaker\\pyNN\\model_binaries\\IF_curr_exp_stdp_mad_nearest_pair_multiplicative.aplx", CoreSubsets([CoreSubset(0, 0, [2, ]),]))
...
reloader.restart(binaries, 128600, 1, turn_off_machine=True)
