...
#This function select the E-pocket randomly according to the num_training value
...
#This function plot raster plot of 4 input recordings in 4 direction
...
#This function plot raster plot of 36 input recordings in 4 direction    
def raster_plot():
    pylab.figure()
    pylab.xlabel('Time/ms')
    pylab.ylabel('spikes')
...
#--------------------------------------------------#
# Excitatory Mode: Observe membrane potential change from one pre-synaptic neuron
# Inhibitory Mode: Observe membrane potential change from one pre-synaptic neuron
...
#import the trained weight to see the evolution of the weight
NetworkInfo = scipy.io.loadmat('trained_weight4dir.mat')
weights_import = NetworkInfo['trained_weight']

#this function convert the weights in Matlab file to a list
...
sim1.Plot_WeightDistribution(pre_pop_size,'Histogram of Trained Weight')
