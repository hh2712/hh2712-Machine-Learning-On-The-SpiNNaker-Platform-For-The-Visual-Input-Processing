...
#sim1.connection_list_converter_normal(self_import = self_import,conn_list = list, mean=0.8, var=0.1,delay = 1)
#sim1.connection_list_converter_uniform(self_import = self_import,conn_list = list, min=0.6, max=1.2, delay = 1)
sim1.connection_list_converter_modified_uniform(self_import = self_import,conn_list = list ,min_h = 0.8,max_h = 1.2,min_l = 0.6,max_l = 0.8,delay = 1)
...
#sim1.display_membrane_potential("Membrane Potential of Post-Synaptic Neuron",xmin= 1600,xmax = 6400,ymin=-70,ymax = -50)
