...
binaries.add_subsets("C:\\Python27\\lib\\site-packages\\spynnaker\\pyNN\\model_binaries\\IF_curr_exp_stdp_mad_nearest_pair_multiplicative.aplx", CoreSubsets([CoreSubset(0, 1, [8, 2, 4, 6, ]),CoreSubset(1, 1, [2, 4, 6, 8, 10, 12, 14, 16, ]),CoreSubset(1, 0, [16, 14, ]),]))
