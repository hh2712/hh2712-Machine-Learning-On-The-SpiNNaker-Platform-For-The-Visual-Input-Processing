...
class IF_curr_exp_s:
    ...
    def plot_spikes(self, spike_type, size, title):
        ...
        if spikes is not None:
            ...
            pylab.axvline(40100,0,1,linewidth = 4, color = 'c',alpha = 0.75,linestyle = 'dashed')
            pylab.axvline(80100,0,1,linewidth = 4, color = 'c',alpha = 0.75,linestyle = 'dashed')
            pylab.axvline(120100,0,1,linewidth = 4, color = 'c',alpha = 0.75,linestyle = 'dashed')
